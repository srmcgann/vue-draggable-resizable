...
export default {
    ...
    watch: {
        setWidth(val) {
            if (val !== this.width) this.width = this.elmW = val;
        },
        setHeight(val) {
            if (val !== this.height) this.height = this.elmH = val;
        },
        setTop(val) {
            if (val !== this.top) this.top = this.elmY = val;
        },
        setLeft(val) {
            if (val !== this.left) this.left = this.elmX = val;
        },
        active(val) {
            this.enabled = val;
        },
